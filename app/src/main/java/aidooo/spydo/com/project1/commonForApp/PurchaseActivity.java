...
public class PurchaseActivity extends AppCompatActivity {
    ...
    private String fromStationNameTxt,toStationNameTxt,user,_fullname,_email,_phonenum,_gender,busTypeTxt;
    ...
    public void nextPurchasePage(View view){
        ...
        if (!validateFromStaton() | !validateToStaton() | !validateBusType()) {
            return;
        }
