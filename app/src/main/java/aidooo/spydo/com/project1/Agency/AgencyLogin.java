...
import aidooo.spydo.com.project1.Common.LoginSignUp.ForgetPassword;
...
public class AgencyLogin extends AppCompatActivity {
    ...
    public void startDashboardPage(View view){
        ...
        Query checkUser= FirebaseDatabase.getInstance().getReference("agencies").orderByChild("username").equalTo(_username);
        checkUser.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (_systemPass.equals(_pass)){
                        ...
                        Toast.makeText(AgencyLogin.this, "Logged in Successfully", Toast.LENGTH_SHORT).show();
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(AgencyLogin.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                progressBar.setVisibility(View.INVISIBLE);
            }
        });
    ...
    public void back(View view){
        Intent intent = new Intent(this, UserAgency.class);
        startActivity(intent);
    }
    ...
    public void onBackPressed() {
        startActivity(new Intent(getApplicationContext(), UserAgency.class));
        finish();
    }
