...
public class AgencyRegistration extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_registration_agency);
    ...
    public void nxt_signUp_scrn(View view) {
        ...
        Intent intent = new Intent(getApplicationContext(), AgencySignUp3rdPage.class);
        ...
        ActivityOptions options = ActivityOptions.makeSceneTransitionAnimation(AgencyRegistration.this, pairs);
